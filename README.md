...
. Ran queries to solve for the questions asked for the analysis, using employees number, name, departments, last name, first name, dept       manager, salaries & titles
